...
/self-learning: in smaller screen, the top bar of the tools don't render properly and it wraps without proper rendering so it overlaps and it just causes UX issues; Any progress made in any of the tools doesn't save so if I 
/settings
/signup
/staff-hub
/store
