...
/contact
/curriculum: It uses the scraper poorly - for example, right now it shows Muzika, Class: Įvertinimas and generate lesson. It does not take Klases darbas as the lesson and uses the 
/exams
/forgot-password
/friends
/game-modes
