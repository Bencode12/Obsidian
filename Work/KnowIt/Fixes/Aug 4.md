...
/coworker: Preload claude skills (.md files) (find the best ones, like stop-slop and skill finder (don't know the actual name) which automatically finds the best ones and 
/challenges
/community
/contact
/curriculum
