...
- Users should be able to see other peoples activities in the same enviroment. Think canva, it puts the persons icon and name on which slide the user is on, do the same, but both on the tool (Documents, 