...
/self-learning: in smaller screen, the top bar of the tools don't render properly and it wraps without proper rendering so it overlaps and it just causes UX issues, 
/settings
/signup
/staff-hub
/store
