...
- Book downloading (like from public libraries) should work like this: You search a book title or the subject it focuses and it just outputs all the books from ALL open libraries (currently