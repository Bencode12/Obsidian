...
- add web search to the AI so it can search up relevant data. Also add anything else an agent might need. And if the agent uses web search, it would show a tic tac styled thingy like in claude or 
