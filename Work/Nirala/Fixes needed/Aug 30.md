...
- if you have some lines written with bulleted list or another type of list, you can drag right click to select those lines and replace say from bulleted to 
