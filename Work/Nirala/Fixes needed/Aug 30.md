...
- limits to how this app should function, as it could be misused as an agentic IDE (say cursor). We need to limit it to just be .md and any similar file and stop the AI from generating code inside .md files. 
